...
import { AbstractMessageReader, MessageReader, DataCallback, MessageBuffer, PartialMessageInfo } from './message-readers/message-readers';
import { AbstractMessageWriter, MessageWriter } from './message-writers/message-writers';
...
export {
	...
	RequestType0, RequestType1, RequestType2, RequestType3, RequestType4,
	RequestType5, RequestType6, RequestType7, RequestType8, RequestType9,
	ResponseMessage, isReponseMessage,
	NotificationMessage, NotificationType,
	NotificationType0, NotificationType1, NotificationType2, NotificationType3, NotificationType4,
	NotificationType5, NotificationType6, NotificationType7, NotificationType8, NotificationType9,
	AbstractMessageReader, MessageReader, DataCallback, MessageBuffer, PartialMessageInfo,
...
export function createMessageConnection(reader: MessageReader, writer: MessageWriter, logger: Logger): MessageConnection {
	let validator = {
		isReader: isMessageReader(reader),
		isWriter: isMessageWriter(writer),
		do() {
			return this.isReader && this.isWriter;
		}
	};
	...
	if (validator.do()) {
		...
		let message = `createMessageConnection - params invalid - ${validator}`;
